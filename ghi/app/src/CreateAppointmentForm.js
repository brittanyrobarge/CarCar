        ...
        <div className="offset-3 col-6">
          <div className="shadow p-4 mt-4">
            ...
            <form onSubmit={handleSubmit} id="add-appointment-form">
              ...
              <div className="form-floating mb-3">
                <input onChange={handleCustomerChange} placeholder="customer" required type="text" name="customer" id="customer" className="form-control" value={formData.customer} />
              ...
              <div className="mb-3">
                <select onChange={handleTechnicianChange} placeholder="Choose a technician" required name="technician" id="technician" className='form-select' value={formData.technician}>
